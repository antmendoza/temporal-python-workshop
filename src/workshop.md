...
The file [System_Patching.md](System_Patching.md) provides an overview of the functionality that will 
be implemented in this workshop.


## [system_patch_workflow_v1.py](workflow/system_patch_workflow_v1.py)
...
Every step defined in the file [System_Patching.md](System_Patching.md) is defined as an activity,
...
Make sure you can run the workflow [system_patch_workflow_v1.py](workflow/system_patch_workflow_v1.py)
...
You can use the file [system_patch_workflow_v1.py](workflow/system_patch_workflow_v1.py) as starting point:
...
You can use the file [system_patch_workflow_v2.py](workflow/system_patch_workflow_v2.py) as starting point:
...
You can use the file [system_patch_workflow_v3.py](workflow/system_patch_workflow_v3.py) as starting point.
...
You can use the file [system_patch_workflow_v4.py](workflow/system_patch_workflow_v4.py) as starting point:
...
You can use the file [system_patch_workflow_v5.py](workflow/system_patch_workflow_v5.py) as starting point
...
You can use the file [system_patch_workflow_v6.py](workflow/system_patch_workflow_v6.py) as starting point:
